...
- `[Fact — verified Aug 2026, see §7.1a]` Brand's FDD is not currently registered (or has lapsed and not been renewed) in the candidate's target state, in the 13 states that require franchise registration before a sale can be offered there — California, Hawaii, Illinois, Indiana, Maryland, Michigan, Minnesota, New York, North Dakota, Rhode Island, Virginia, Washington, Wisconsin. Offering a brand to a candidate in one of these states while its registration has lapsed is not a soft ranking problem, it's a legal exposure for the franchisor and an unusable match for the candidate — this has to be a hard filter, checked at match time, not a caveat shown after the fact.
...
`[Fact — verified Aug 2026]` The memo is a supplement to, never a substitute for, the franchisor's own Franchise Disclosure Document. Under the FTC Franchise Rule (16 CFR Part 436), a prospective franchisee must receive the actual FDD at least 14 calendar days before signing any binding agreement or making any payment to the franchisor. `[Product]` The platform's workflow must hard-block deal progression (signature, deposit, any payment) inside that 14-day window from FDD receipt, and the diligence memo must timestamp when the candidate received the FDD it references — this is a compliance control on the launch workflow (§8), not just a matching-stage nicety. — [FTC Franchise Rule, 16 CFR 436](https://www.ftc.gov/legal-library/browse/federal-register-notices/16-cfr-part-436-disclosure-requirements-prohibitions-concerning-franchising-rule-franchise-rule); [eCFR 16 CFR 436](https://www.ecfr.gov/current/title-16/chapter-I/subchapter-D/part-436)
...
#### 7.1a The directory itself is not stable — verified, not assumed

`[Fact — verified Aug 2026]` The SBA Franchise Directory was **discontinued in 2023 and reinstated effective June 1, 2025**; the file in effect as of this writing is dated July 24, 2026. This is not a hypothetical entry in the risk table at §17 ("SBA policy changes") — it already happened once, for roughly two years, and any product depending on the directory's existence needs a fallback state (what the eligibility engine does, and what it tells candidates/lenders, if the directory goes dark again) designed in from the start, not bolted on after the fact. — [Foley & Lardner: SBA Franchise Directory Reinstated](https://www.foley.com/insights/publications/2025/05/sba-franchise-directory-reinstated-easing-loan-access-franchisees/); [SBA: Franchise Directory](https://www.sba.gov/document/support-sba-franchise-directory)

`[Assumption — needs a live pull to confirm]` The specific 3,277 / 2,254 / 1,009 counts predate the 2023–2025 gap and should be treated as illustrative of the directory's *structure* (a mix of coded-in and coded-out listings), not as current figures — re-pull the live spreadsheet before operationalizing any count-based claim.
...
`[Fact — verified Aug 2026, current SBA SOP 50 10 8]` Two of these are not soft judgment calls, they're bright-line SBA rules the readiness-assessment output must state plainly, before an application is ever packaged:
- **Personal guarantee:** any individual owning 20% or more of the borrowing entity must sign an unlimited personal guarantee. For a change-of-ownership deal (e.g., a resale), a seller retaining less than 20% post-sale is still required to guarantee for two years. A candidate structuring ownership specifically to stay under 20% and avoid a guarantee should be flagged, not quietly accommodated — that's the kind of structure a lender will unwind in underwriting anyway.
- **Minimum equity injection:** at least 10% of total project cost (purchase price + transaction expenses + working capital) for both startups and full changes of ownership. The financing-readiness score should show this as a hard cash-required number next to the candidate's stated liquid capital, not bury it in a term sheet later.
— [Live Oak Bank: SBA SOP 50 10 8 Key Updates](https://www.liveoak.bank/blog/navigating-the-sbas-new-sop-50-10-8); [PGI: SBA 7(a) Personal Guarantee Rules 2026](https://pgicover.com/blog/posts/sba-7a-personal-guarantee-2026/)
...
### 7.3a Loan-referral fee licensing — verified, and it changes the Phase 1 answer

§16 and §19 previously flagged referral-fee licensing as an open, potentially blocking unknown. It's more tractable than assumed, and the structural choice it forces should be a deliberate product decision, not an afterthought:

`[Fact — verified Aug 2026]` Only nine states require a license to broker **commercial** loans: California, Arizona, Arkansas, Florida, Maryland, Nevada, North Dakota, South Dakota, and Wisconsin (California's Finance Lenders Law / CFLL is the one most likely to bind here, given the population of franchise activity in-state). In every state — including those nine, as long as the activity stays within the license-exempt lane — a **flat, name-and-number referral** (hand off contact information for a fee, with no negotiation of rate, term, points, or prepayment terms, and no collection of financial documents on the lender's behalf) does not require a broker license. — [FunderIntel: State-by-State Guide to Business Loan Broker Licensing](https://www.funderintel.com/post/do-you-need-a-license-to-broker-business-loans); [C-Loans: Are Referral Fees on Commercial Loans Legal?](https://info.c-loans.com/are-referral-fees-on-commercial-loans-legal); [Mayer Brown: California Moving to License All Commercial Loan Brokers](https://www.mayerbrown.com/en/insights/publications/2024/01/california-moving-to-license-all-commercial-loan-brokers)

`[Product]` This is a real design constraint, not a footnote: to earn the referral fee in §16 without licensing in all 50 states on day one, the human analyst and the platform's UI must stay strictly in "here is a matched lender, here is what SBA rules generically require" territory, and **route rate/term/document discussion to the lender's own loan officer**, not conduct it in-app. The moment the platform starts negotiating terms or collecting financial statements on a specific lender's behalf, it likely needs licensing in at least California (and possibly the other eight) before continuing. `[Assumption]` California is flagged as a live compliance-in-motion risk — the Mayer Brown source above describes proposed expansion of California's licensing regime to cover more commercial loan brokers; this needs a fresh check before any California-based rollout, not a one-time read of a 2024 article.
...
| Lender referral/origination fee | Lender | On funded loan | High margin | `[Fact — verified Aug 2026]` Only 9 states license commercial loan brokers (CA, AZ, AR, FL, MD, NV, ND, SD, WI); a flat, name-and-number referral with no rate/term negotiation is unlicensed in all 50 (§7.3a) | Must not bias routing toward the lender paying most (§6.4 logic extends here) | **Yes — at MVP, if the product is kept to pure name-and-number referral (§7.3a); California needs a fresh compliance check before rollout there** |
...
| FTC Franchise Rule 14-day disclosure window | Diligence memo (§6.5), launch workflow (§8) | `[Fact — verified Aug 2026]` No signature or payment may be taken within 14 calendar days of the candidate receiving the franchisor's actual FDD (16 CFR 436); workflow hard-blocks this, timestamped from FDD receipt |
| State FDD registration lapses | Matching hard filter (§6.3) | `[Fact — verified Aug 2026]` 13 states require current FDD registration before a sale may be offered there (CA, HI, IL, IN, MD, MI, MN, NY, ND, RI, VA, WA, WI); registration status checked at match time, not assumed static |
| Loan-broker/finder licensing | Financing referral fees | `[Fact — verified Aug 2026]` Only 9 states license commercial loan brokers; stay within the unlicensed "name-and-number referral" lane (no rate/term negotiation, no document collection on a lender's behalf) at MVP (§7.3a); revisit before any state-specific expansion, especially California |
...
| ECOA / Regulation B adverse action | Any point where the platform's score materially shapes a credit outcome | `[Fact — verified Aug 2026]` Regulation B's adverse-action notice duty (12 CFR 1002) applies to business-credit applicants, not just consumer ones, and reasons must be specific — "didn't meet our internal score" is an insufficient reason on its own. A pure-referral posture (§7.3a) keeps the *lender* as the party issuing adverse action notices; if the platform's readiness score starts functioning as a de facto credit decision (e.g., a "not ready" score that lenders treat as a pre-decline), the platform may itself take on ECOA creditor obligations — a line to watch, not cross unnoticed |
| CFPB Section 1071 / small-business lending data | Only relevant once the company originates or materially influences loan decisions at volume (Engine 2/3) | `[Fact — verified Aug 2026]` CFPB's revised Section 1071 rule (final May 1, 2026, effective June 30, 2026) applies to "covered financial institutions" above a 1,000-origination annual threshold, with data collection starting Jan 1, 2028. Not a Phase 1–2 concern under a pure-referral model, but a hard gate to check before Engine 2/3 originates loans at scale |
...
The honest reading: **Phase 1 economics likely don't work on advisory fees alone**; the model depends on either (a) lender-referral fees clearing licensing quickly, or (b) 2–3 franchisor placement-fee relationships anchoring revenue while the deal-volume flywheel builds. `[Fact — verified Aug 2026, see §7.3a]` (a) is now the less risky of the two: name-and-number lender referral fees don't require licensing in 41 states, and the licensed-state list is small and known (CA, AZ, AR, FL, MD, NV, ND, SD, WI). That derisks the "clearing licensing quickly" assumption considerably — provided Phase 1 stays disciplined about not drifting into rate/term negotiation, which is the thing that would actually trigger a license requirement. This should still be treated as a go/no-go input for the 90-day plan, but the licensing leg of it is no longer the open question it was.
...
- ~~What are current, re-verified SBA Franchise Directory counts and the actual current text of its notes/flags?~~ **Partially resolved (§7.1a):** the directory was discontinued 2023–2025 and reinstated June 1, 2025; current file dated July 24, 2026. The specific 3,277/2,254/1,009 counts predate the gap and still need a fresh pull before use — the fallback-state design question (what happens if it goes dark again) is now a known, not-yet-answered requirement rather than an unknown one.
- ~~Which states have loan-broker/finder licensing regimes that make the referral-fee revenue stream fast to activate vs. slow?~~ **Resolved (§7.3a):** only 9 states (CA, AZ, AR, FL, MD, NV, ND, SD, WI) require a commercial-loan-broker license, and a pure name-and-number referral is unlicensed everywhere. Remaining open item: confirm California's licensing regime hasn't since expanded (it was reported as in motion as of a 2024 source) before including CA candidates in Phase 1.
